...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <source src="/video/21Trucking.webm" type="video/webm" />
      </video>
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-end min-h-[calc(100vh-80px)]">
        <div className="max-w-3xl w-full text-center sm:text-right">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center sm:text-center"
          >
            {[
              {
                amount: "Up to $0.85",
              ...
              },
              {
                amount: "+$100",
                label: "each week",
                description: "Bonus after 4 weeks",
              },
              {
                amount: "3,000+",
                label: "Miles/Week",
